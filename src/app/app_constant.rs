...
pub const ZEP_IMPL_SLOT: &str =
    "0xe3caa0b6d0569366f92f8438abfdb232378cfd332e9dc8656f33322176d86c38";
pub const ZEP_ADMIN_SLOT: &str =
    "0xe59ed60ca6e4e7df6bd875f45f3199fa50d18f9f8eab0cbc73f528c3bf38189c";

pub const IMPLEMENTATION_SLOTS: [&str; 2] = [EIP1967_IMPL_SLOT, ZEP_IMPL_SLOT];
pub const ADMIN_SLOTS: [&str; 2] = [EIP1967_ADMIN_SLOT, ZEP_ADMIN_SLOT];
